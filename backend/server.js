...
// --- ROTAS DA API (Cadastro, Login, Desafios) ---
// (Estas eram as rotas que estavam quebradas no seu original, agora estão corretas)
...
// 3. INICIA O SERVIDOR (no final do arquivo, fora de qualquer callback)
app.listen(PORT, () => {
